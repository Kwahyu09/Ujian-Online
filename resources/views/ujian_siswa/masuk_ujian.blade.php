...
<div class="row">
    ...
    @else
    @if ($soal)
    <div class="col-md-8 col-sm-12 mb-3 ml-3">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio"
                            @foreach($evaluasi as $eval)
                                ...
                                @endif
                            @endforeach
                            name="jawaban" id="jawaban" value="{{ $s->opsi_a }}">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio"
                            @foreach($evaluasi as $eval)
                                ...
                                @endif
                            @endforeach
                            name="jawaban" id="jawaban" value="{{ $s->opsi_b }}">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio"
                            @foreach($evaluasi as $eval)
                                ...
                                @endif
                            @endforeach
                            name="jawaban" id="jawaban" value="{{ $s->opsi_c }}">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio"
                            @foreach($evaluasi as $eval)
                                ...
                                @endif
                            @endforeach
                            name="jawaban" id="jawaban" value="{{ $s->opsi_d }}">
                ...
                <div class="form-group mr-3 mb-3 mt-0 d-flex justify-content-center">
                    @if ($evaluasi->count() > 0 && $evaluasi_exists)
                        <button class="btn btn-warning" type="submit">Ubah Jawaban</button>
                    @else
                        <button class="btn btn-primary" type="submit">Tambah Jawaban</button>
                    @endif
                    </form>
                </div>
                <div class="card-footer mr-3 mb-3 mt-0 d-flex justify-content-center"></div>
                @endforeach
            </div>
        </div>
    </div>
