        ...
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center">
           <div class="w-100 mb-0 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="/login">
              <img id="logo" width="100px" src="/assets/images/smk.png" alt="Logo SMK N 4 Kota Bengkulu">
            </a>
           </div>
          ...
          <div class="form-group">
            ...
            <input type="email" name="email" id="email" class="form-control form-control-lg" placeholder="Email.." required="" autofocus="">
          </div>
          <div class="form-group">
